...
//!
//! - [`omiai_probabilistic::gibbs`] — Gibbs sampling.
//! - [`omiai_probabilistic::mean_field`] — Mean-field variational inference.
//! - [`omiai_core::ltl`] — Linear Temporal Logic satisfiability.
//! - [`omiai_core::modal`] — Modal Logic K model checking.
//! - [`omiai_core::higher_order_unification`] — HU unification Branches API.
//! - [`omiai_probabilistic::junction_tree`] — Junction Tree division-step fix.
//!
//! Run with: `cargo test --release --test integration_v3`

use std::collections::HashMap;

use omiai_core::higher_order_unification::{Term, Type, unify_terms};
use omiai_core::ltl::{LtlFormula, is_satisfiable};
use omiai_core::modal::{KripkeStructure, ModalFormula, satisfies, two_world_model};
use omiai_probabilistic::bayesian::{BayesianNetwork, Cpt};
use omiai_probabilistic::gibbs::{GibbsConfig, gibbs_query, gibbs_sample};
use omiai_probabilistic::junction_tree::JunctionTree;
use omiai_probabilistic::mean_field::{MfConfig, mean_field};
